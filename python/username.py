...
# from the current year. Please make sure that your function delivers the correct birth year
...
# Order of the objects in the array should be maintained but order of the properties in the 
# individual objects does not matter.
