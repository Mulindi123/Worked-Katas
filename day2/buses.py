...
# It is known that some children and adults are going to go to the camp. 
# Each bus has a certain number of seats places. There must be at least two adults
# on each bus in which children will travel.

# Determine whether it will be possible to send all children and adults to the camp, and if so,
# what is the minimum number of buses required to order for this.
# Input data:
