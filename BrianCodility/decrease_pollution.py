...
# Then the total pollution will be 5 + ((19 / 2) / 2) + (8 / 2) + 1 = 5 + 4.75 + 4 + 1 = 14.75 which is
# less than 33 / 2 = 16.5, so we have achieved our goal.

# 2. Given A = [10, 10], your function should return 2, because we may install one filter at each factory.

# 3. Given A = [3, 0, 5], your function should return 2, because it is sufficient to install one filter at
# each factory producing a non-zero amount of pollution.
